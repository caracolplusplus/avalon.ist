const countries = [
  ...
  { text: "Democratic's People Republic of Korea", value: 'KP' },
  ...
  { text: 'Macao', value: 'MO' },
  { text: 'The Former Yugoslav Republic of Macedonia', value: 'MK' },
